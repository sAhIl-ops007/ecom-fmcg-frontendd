...
import { FaPlus , FaUserCog, FaSignOutAlt } from 'react-icons/fa';
    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <ul className="space-y-3">
          ...
          <li>
            <Link 
              ...
              className="flex items-center p-3 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-all group"
            >
              <FaPlus  className="mr-3 text-lg text-purple-500 group-hover:text-purple-600" /> 
      ...
      <div className="flex-1 p-6 overflow-auto">
        <div className="max-w-6xl mx-auto bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          {/* Admin Information */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100">Vendor Information</h3>
